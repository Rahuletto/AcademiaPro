...
export default function ErrorComponent({
	...
	return (
		<html
			lang="en"
			className="h-screen w-screen absolute top-0 bg-light-error-background p-8 text-light-error-color dark:bg-dark-error-background dark:text-dark-error-color"
		>
			<body className="h-full w-full rounded-2x">
          ...
          <button
            onClick={reset}
            className="mt-8 rounded-2xl border-2 border-light-error-color px-5 py-2 text-light-error-color dark:border-dark-error-color dark:text-dark-error-color"
          >
            Ignore
          </button> */}
				</div>
