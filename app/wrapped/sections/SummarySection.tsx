...
export default function SummarySection() {
  ...
  return (
    <>
      <div className="relative mx-2 mt-10 my-10 flex h-[100vh] z-50 min-h-[680px] max-h-[740px] lg:max-h-[760px] w-[100vw] max-w-[500px] flex-col items-start justify-start overflow-hidden rounded-3xl p-8 md:h-[80vh]">
        <div
