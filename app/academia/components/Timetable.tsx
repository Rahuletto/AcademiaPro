...
export default function Timetable() {
  ...
  return (
    <section id="timetable" className="flex flex-col gap-6">
      ...
      {timetable ? (
        <div className="transition duration-200 text-md min-w-full animate-fadeIn rounded-2xl bg-light-background-dark p-1 text-left dark:bg-dark-background-normal">
          <TableHeader />
          <Tabler />
        </div>
      ) : isLoading ? (
