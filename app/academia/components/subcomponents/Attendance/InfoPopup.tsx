...
const InfoPopup: React.FC<InfoPopupProps> = ({
  ...
  <div
    ...
    className={`absolute ${bottom ? "top-6" : "bottom-6"} z-30 md:-left-20 -left-28 w-48 animate-fadeIn rounded-xl bg-light-background-light bg-opacity-60 text-light-color shadow-lg backdrop-blur-sm dark:bg-dark-background-light dark:bg-opacity-70 dark:text-dark-color`}
  >
