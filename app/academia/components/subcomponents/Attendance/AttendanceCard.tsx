...
export default function AttendanceCard({
  ...
  return (
    <div
      tabIndex={0}
      role="gridcell"
      className="my-6 grid w-full grid-cols-[3fr_1fr] grid-rows-[repeat(2,1fr)] items-center gap-3 gap-y-2 rounded-3xl p-4 px-6 -mx-3 transition duration-200 md:my-0 md:flex md:items-center md:justify-between md:rounded-xl"
    >
