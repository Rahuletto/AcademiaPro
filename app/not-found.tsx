  ...
  return (
    <main className='h-screen w-screen bg-light-info-background flex-col dark:bg-dark-info-background flex items-center justify-center'>
        ...
        <div className='flex items-center flex-col mt-4 gap-2 justify-center text-light-color dark:text-dark-color'>
            ...
            <p className='font-mono opacity-70 max-w-screen-sm text-center mx-3'>We don&apos;t know what you were looking for, but it never existed. Don&apos;t worry, i gotchu.</p>

            <button onClick={() => router.back()} className='bg-light-info-color mt-12 dark:bg-dark-info-color text-light-background-normal dark:text-dark-background-normal p-2 px-5 rounded-xl font-semibold hover:bg-light-button-hover dark:hover:bg-dark-button-hover'>Go back</button>
        </div>
    </main>
  )
}
