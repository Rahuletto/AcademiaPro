  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center">
        <div className="flex w-full max-w-md flex-col items-center justify-center rounded-lg bg-gray-800 p-6">
          <div className="flex w-full flex-col items-center justify-center">
            ...
            <button
              className="mb-6 rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-700"
              name="Better lab"
