...
export default function Error({
  ...
  return (
    <div
      ...
      tabIndex={0}
      onClick={() => alert(error)}
      className="flex h-full max-h-[80vh] min-w-full animate-fadeIn flex-col items-center justify-center gap-2 rounded-2xl bg-light-error-background p-8 text-light-error-color dark:bg-dark-error-background dark:text-dark-error-color"
    >
