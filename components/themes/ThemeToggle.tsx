                    ...
                    <div className="absolute z-20 mt-2 w-32 top-8 right-0 rounded-lg shadow-lg bg-light-background-light dark:bg-dark-background-darker">
                        ...
                        >
                            {sortedThemes.map((theme) => (
                                <li
                                    key={theme.title}
                                    className={`cursor-pointer select-none rounded-lg font-semibold relative py-2 pl-3 pr-9 hover:bg-light-input dark:hover:bg-dark-input ${
                                        actualtheme === theme.title ? "bg-light-input dark:bg-dark-input" : ""
                                    }`}
                                    onClick={() => {
                                ...
                                >
                                    {theme.title === "BW" ? "Batman" : theme.title}
                                </li>
                            ))}
                        </ul>
                    </div>
