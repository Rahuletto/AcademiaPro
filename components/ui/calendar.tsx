...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months: "flex flex-col sm:flex-row w-fit mx-auto space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4",
        ...
        day_selected:
          "bg-light-accent text-white hover:bg-neutral-900 hover:text-light-accent focus:bg-light-accent focus:text-light-accent dark:bg-dark-accent dark:text-black dark:hover:bg-neutral-50 dark:hover:text-dark-accent dark:focus:bg-dark-accent dark:focus:text-black",
