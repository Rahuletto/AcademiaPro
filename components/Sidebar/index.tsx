      ...
      <>
        ...
        >
          ...
          >
            ...
            <div className="dark:text-dark-accent font-medium text-light-accent bg-light-info-background dark:bg-dark-info-background h-10 flex items-center justify-center w-full absolute -top-1 rounded-t-xl">Sem Wrapped&apos;24</div>
          </div>
